...
public class AIS328DQTR
{
	public static void main(String args[]) throws Exception
	{
		// Create I2C bus
		I2CBus bus = I2CFactory.getInstance(I2CBus.BUS_1);
		// Get I2C device, AIS328DQTR I2C address is 0x18(24)
		I2CDevice device = bus.getDevice(0x18);

		// Select control register1
		// X, Y, and Z axis enabled, power on mode, data rate o/p 50Hz
		device.write(0x20, (byte)0x27);
		// Select control register4
		// Full scale +/- 8g, continuous update
